...
const char *dbfile_dir = "/home/deepak/Desktop/dbi/tpch-dbgen/10MB/bin/"; // dir where binary heap files should be stored
const char *tpch_dir ="/home/deepak/Desktop/dbi/tpch-dbgen/10MB/"; // dir where dbgen tpch files (extension *.tbl) can be found
