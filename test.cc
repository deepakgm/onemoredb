...
const char *dbfile_dir = "/home/gurpreet/Desktop/temp/t"; // dir where binary heap files should be stored
const char *tpch_dir ="/home/gurpreet/Desktop/temp/git/tpch-dbgen/"; // dir where dbgen tpch files (extension *.tbl) can be found
